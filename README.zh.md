...
构建脚本采用 MIT 许可。策展、原创说明、翻译和 YouArt 生成的示例图片采用 CC BY 4.0：注明出处后即可复制、修改和商用。

提示词及其标题仍属于各自作者。ATTRIBUTION.md 为每一条保留作者、原帖，以及来源合集声明的 CC0 1.0 或 CC BY 4.0 条款；我们不对第三方作品授予额外权利。
